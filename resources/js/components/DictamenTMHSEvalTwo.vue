      ...
      <q-card style="width: 600px; max-width: 70vw">
        <q-card-section class="row no-padding">
          <q-toolbar class="bg-primary text-white">
            <q-toolbar-title>Dictamen</q-toolbar-title>
        ...
        <q-card-section>
          <div class="row">
            <div class="text-subtitle1 text-weight-bold text-uppercase">
              Gestionar dictamen 2da evaluación
            </div>
            <q-space></q-space>
            <q-input
              dense
...
<q-input
                    ...
                    v-model="form.fechaSegundaEvaluacion"
                      @click="$refs.qDatefechaSegundaEvaluacion.show()"
                  >
                    <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                        <q-popup-proxy
                          ref="qDatefechaSegundaEvaluacion"
                          transition-show="scale"
                          transition-hide="scale"
                        >
                          <q-date
                ...
                <div class="row q-mt-sm">
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 q-px-sm"> 
                         <strong>Resultado de la segunda evaluación</strong></div>
                </div>
                      <div class="row">
                        ...
                        >
                           <q-input
                              ref="puntuacionObtenidaSegundaEval"
                              v-model="form.puntuacionObtenidaSegundaEval"
                        ...
                        >
                          <q-input
                              type="number"
                              ref="requisitoIncumplidoSegundaEval"
                              v-model="form.requisitoIncumplidoSegundaEval"
                        ...
                        <div
                          class="col-xs-12 col-sm-12 col-md-12 col-lg-4 q-px-sm"
                        >
                           <q-input
                              label="Observación"
                              v-model="form.observacionSegundaEval"
                              type="textarea"
                              autogrow
                            />
                        </div>
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: "left",
          label: "Evaluación",
          field: (row) => row.tipo_eval.nombre,
          sortable: true,
          headerClasses: "text-uppercase",
        },
        {
  ...
  mounted() {
    this.$root.$on("openTableDictEvalTwo", (data) => {
  ...
  methods: {
    ...
    closeModal() {
      this.$root.$emit("closeTableDictEvalTwo");
      this.reset_form();
    ...
    reset_form() {
      ...
      this.form.puntuacionObtenida = 0; //number
    ...
    async save() {
      let evalObj = this.tiposEvals.find((value) => value.codigo == "segunda");
