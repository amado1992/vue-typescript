  ...
  <div class="q-pa-md">
    <q-card>
      ...
      <q-card-section>
        <q-table
          class="table-title"
          title="Gestionar tipo de grupo electrógeno"
                ...
                <q-toolbar-title>
                  {{
                    this.accion == "adicionar"
                      ? "Adicionar tipo de grupo electrógeno"
                      : "Actualizar tipo de grupo electrógeno"
                  }}
                </q-toolbar-title>
                <q-btn
                  round
...
export default {
  ...
  mounted() {
    this.addToHomeBreadcrumbs([
      ...
      { label: "Nomencladores" },
      { label: "Tipo de grupo electrógeno" }
    ]);
  },
  watch: {
    someText() {
  ...
  methods: {
    ...
    confirmDelete(dataRow) {
      this.$q
        .dialog({
          title: "Confirme",
          message: "¿Estás seguro que desea eliminar este tipo de grupo electrógeno?",
          cancel: true,
          persistent: true,
        })
        .onOk(() => {
    ...
    async save() {
      ...
      return await axios
        .post("/api/tipo_ge", this.form_create)
        .then((result) => {
          this.loadData();
    ...
    async update() {
      ...
      return await axios
        .put("/api/tipo_ge/" + id, this.form_create)
        .then((result) => {
          this.loadData();
