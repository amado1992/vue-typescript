          ...
          <q-card-section class="no-padding">
            ...
            <q-card-section>
              <div class="row q-gutter-y-xs">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 q-px-sm">
                  <q-select
                    v-model="form_create.mtempresa_id"
                    :options="empresas"
                    label="Empresas *"
                    options-dense
                    option-value="id"
...
export default {
  ...
  mounted() {
    this.addToHomeBreadcrumbs([
      ...
      { label: "Nomencladores" },
      { label: "Uebs asociadas a empresas" }
    ]);
  },
  watch: {},
  computed: {
  ...
  methods: {
    ...
    confirmDelete(dataRow) {
      this.$q
        .dialog({
          title: "Confirme",
          message: "¿Estás seguro que desea eliminar este ueb?",
          cancel: true,
          persistent: true,
        })
        .onOk(() => {
    ...
    async update() {
      ...
      return await axios
        .put("/api/ueb/" + id, this.form_create)
        .then((result) => {
          this.loadData();
